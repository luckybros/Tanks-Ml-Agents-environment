...
{
    public class ShellExplosionML : MonoBehaviour
    {
        ...
        private void OnTriggerEnter (Collider other)
        {
            ...
            for (int i = 0; i < colliders.Length; i++)
            {
                ...
                targetRigidbody.GetComponent<TankMovementML>().AddExplosionForce(m_ExplosionForce, transform.position, m_ExplosionRadius);

                // Find the TankHealth script associated with the rigidbody.
                TankHealthML targetHealth = targetRigidbody.GetComponent<TankHealthML> ();
