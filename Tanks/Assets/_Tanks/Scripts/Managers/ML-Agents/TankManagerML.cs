...
namespace Tanks.Complete
{
    ...
    public class TankManagerML
    {
        ...
        private TankMovementML m_Movement;                        // Reference to tank's movement script, used to disable and enable control.
        private TankShootingML m_Shooting;                        // Reference to tank's shooting script, used to disable and enable control.
        ...
        private bool m_IsMLAgentControlled;
        
        public void Setup (GameManagerML manager)
        {
            // Get references to the components.
            m_Movement = m_Instance.GetComponent<TankMovementML> ();
            m_Shooting = m_Instance.GetComponent<TankShootingML> ();
            m_Agent = m_Instance.GetComponent<TankAgent>();
    ...
    public class TankManagerDrawerML : PropertyDrawer
    {
