...
namespace Tanks.Complete
{
    public class GameManagerML : MonoBehaviour
    {
        ...
        public TankManagerML[] m_SpawnPoints;         // A collection of managers for enabling and disabling different aspects of the tanks.

        public bool m_IsMLAgentControlled;
        ...
        private TankManagerML m_RoundWinner;          // Reference to the winner of the current round.  Used to make an announcement of who won.
        private TankManagerML m_GameWinner;           // Reference to the winner of the game.  Used to make an announcement of who won.
        ...
        private void SpawnAllTanks()
        {
            ...
            for (int i = 0; i < m_PlayerCount; i++)
            {
                ...
                var mov = m_SpawnPoints[i].m_Instance.GetComponent<TankMovementML>();
        ...
        private TankManagerML GetRoundWinner()
        {
            // Go through all the tanks...
            for (int i = 0; i < m_PlayerCount; i++)
            {
        ...
        private TankManagerML GetGameWinner()
        {
            // Go through all the tanks...
            for (int i = 0; i < m_PlayerCount; i++)
            {
